...
def mine_block():
    ...
    #     response1 = {'message':'The nodes had diferents chains so the chain was replaced by the longest one',
    #                 'new_chain':blockchain.chain}
    # else:
    #     response1 = {'message':'Everything is ok. The chain is the longest one',
    ...
    # for node in blockchain.nodes:
    #     replace_c = requests.get(url=f'http://{node}/replace_chain')
    #     print(replace_c.text)
