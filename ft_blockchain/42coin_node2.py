...
def mine_block():
    ...
    #     response2 = {'message':'The nodes had diferents chains so the chain was replaced by the longest one',
    #                 'new_chain':blockchain.chain}
    # else:
    #     response2 = {'message':'Everything is ok. The chain is the longest one',
